...
const Calendar: React.FC = () => {
  ...
  const [eventRelation, setEventRelation] = useState<string>("no");
      ...
      >
        <Box style={{ backgroundColor: "white" }}>
          ...
          <form onSubmit={(e) => submitHandler(e)}>
            ...
            <input type="color" value={eventRelation} list="data1" />
            <datalist id="data1">
              <option
                value="#ff0001"
                onClick={(e) => setEventRelation("#ff0001")}
              ></option>
              <option
                value="#000000"
                onClick={(e) => setEventRelation("#ffffff")}
              ></option>
              <option
                value="#ffffff"
                onClick={(e) => setEventRelation("#ffffff")}
