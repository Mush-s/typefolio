      ...
      >
        <Box style={{ backgroundColor: "white" }}>
          ...
          <form onSubmit={(e) => submitHandler(e)}>
            ...
            />
            <input type="color" value={eventColor} list="data1" />
            <datalist id="data1">
              <option value={eventColor} onChange={(e) => setEventColor("#ff0001")}></option>
              <option onChange={(e) => setEventColor("#ff0001")}></option>
              <option onChange={(e) => setEventColor("#ff0001")}></option>
            </datalist>
            <input type="submit" />
          </form>
