  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.rule}>
        <h2 className={styles.title}>Rule</h2>
        <h3 className={styles.high}>rgb(255,0,0) : HighSchool</h3>
        <h3 className={styles.uni}>rgb(0,255,0) : University</h3>
        <h3 className={styles.jun}>rgb(0,0,255): Junior HighSchool</h3>
        <form>
          <input type="text" />
        </form>
      </div>
